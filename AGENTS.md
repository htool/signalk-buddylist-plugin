...
- Slice 2 (alert NM, message text, URN default, name-missing) is implemented.
- Next commit is features.md slice 3 (optional relative bearing). No other features in that commit.
